      ...
      {({
        ...
        <Form onSubmit={handleSubmit} className="mt-auto mx-5 my-3">
          <Form.Group className="d-flex border rounded py-1">
            <Form.Control className="border-0 px-2" required type="textarea" placeholder={t('messages.input.placeholder')} name="body" value={values.body} onChange={handleChange} />
            <Button className="border-0" variant="group-vertical" type="submit" disabled={values.body.length === 0}>
